...
namespace ERP.Web
{
    public class Utility
    {
        ...
        public string GetConfigEmail(HttpSessionStateBase Session, IProductConfigurationService configurationService)
        {
        ...
        public string GetConfigMaxDiscount(HttpSessionStateBase Session, IProductConfigurationService configurationService,bool isAdmin)
        {
            if (isAdmin)
            {

                return ConfigurationManager.AppSettings["AdminAllowedDiscount"];
        ...
        public string GetDefaultVendor(HttpSessionStateBase Session, IProductConfigurationService configurationService)
        {
            if (Session[Utility.ProductConfiguration] == null)
            {
                ProductConfiguration config = configurationService.GetDefaultConfiguration();
            ...
            return toReturn!=null?toReturn.DefaultVendorId.ToString():"0";
        }
